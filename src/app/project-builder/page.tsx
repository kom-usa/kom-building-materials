    ...
    <>
      <section className="bg-[var(--color-brand-green)] text-white py-14 px-4">
        <div className="mx-auto max-w-4xl">
          <p className="text-sm text-[var(--color-brand-dark)] font-semibold mb-2">Project Builder</p>
      ...
      <section className="py-20 px-4 bg-[var(--color-background)]">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[var(--color-brand-green)]/10 mb-6">
            <svg className="w-8 h-8 text-[var(--color-brand-green)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <a
                key={cat.href}
                href={cat.href}
                className="block rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-[var(--color-text)] text-center hover:border-[var(--color-brand-green)] hover:bg-[var(--color-brand-green)]/5 transition-colors"
              >
                {cat.label}
              </a>
            ))}
          ...
          <div className="mt-6">
            <a
              href="/contact"
              className="inline-block rounded bg-[var(--color-brand-green)] px-6 py-3 text-sm font-semibold text-white hover:bg-[var(--color-brand-green-dark)] transition-colors"
            >
              Request a Quote Now
            </a>
          </div>
